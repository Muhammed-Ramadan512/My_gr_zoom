...
Future<void> checkAndDownloadSDK(String location) async {
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse(
            'https://com21-static.s3.sa-east-1.amazonaws.com/zoom/ios/6.1.5/ios-arm64/MobileRTC?dl=1'),
        iosSDKFile);
  }
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse(
            'https://com21-static.s3.sa-east-1.amazonaws.com/zoom/ios/6.1.5/ios-arm64_x86_64-simulator/MobileRTC'),
        iosSimulateSDKFile);
  }
